...
def run_app():
    ...
    if st.session_state.stage == 0:
        ...
        result_key_map = {
            6: None, # This will be determined by scoring
            101: 'internal_naming',
            102: 'comms_initiative',
            103: 'legal_directive',
            104: 'independent_risk',
            105: 'strategically_aligned', # JV default
            106: 'strategically_aligned', # Acquisition default
            107: 'retire_rebrand'
        }
        ...
        if outcome_key:
            display_recommendation(
                RESULT_DATA[outcome_key]['recommendation'],
                RESULT_DATA[outcome_key]['rationale'],
                RESULT_DATA[outcome_key]['examples']
            )
